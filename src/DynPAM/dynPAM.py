...
from utils import position_enzymes, set_start_concentrations_enzymes, position_exchange_reactions, set_start_concentrations
...
class DynamicPAM:
    def __init__(self, model: Model, max_production, max_degradation, michaelis_menten_parameters: dict, objective_function_id: str):
        self.model = model
    ...
    def rhs(self, t, concentrations):
        ...
        # Update metabolite reaction bounds using Michaelis-Menten kinetics
        ...
        for enzyme_id, position in self.dict_position_enzymes.items():
            ...
            d_concentration_dt[position] = flux
    ...
    def simulate(self, t0: float, tf: float, start_concentrations: dict, data_list: bool = True, plot: bool = True, plot_ids=None, exclude_ids=None, only_positive=False, plot_biomass_separately=False):
        ...
        try:
            t, concentrations = solver.simulate(tf)
